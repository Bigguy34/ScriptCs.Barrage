...
namespace ScriptCs.Barrage.Storage.Model 
{
    ...
    public partial class Diagnostic : BrightstarEntityObject, IDiagnostic 
    {
    	...
    	{
            		get { return GetRelatedProperty<System.Int64>("RequestInterval"); }
            		set { SetRelatedProperty("RequestInterval", value); }
    	}
    	...
    	{
            		get { return GetRelatedProperty<System.String>("Response"); }
